...
function LoginPage(props){
  ...
  return(
    <div style={{width:'1000px', height:'900px', backgroundColor:'#E8F3EF'}}>
      <div class="LoginFormOutest" style={{height:'8%'}}>
        ...
        style={{fontWeight:'bold',
                ...
                paddingBottom:'7px',
                position:'relative',
                 left:175, top:-20}}>LOG IN</div>
        <div class="break" style={{width:'40%'}}></div>
      </div>
      <div class="LoginFormOutest" style={{height:'9%',left:100}}>
        <div class="break" style={{width:'10%'}}></div>
        <div class={candidateClassName} style={{width:'40%',fontWeight:'bold'}} onClick={()=>{if(!activeCandidateBtn)setBtn(true)}}>Candidate</div>
        <div class={companyClassName} style={{width:'40%',fontWeight:'bold',}} onClick={()=>{if(activeCandidateBtn)setBtn(false)}}>Company</div>
        <div class="break" style={{width:'10%'}}></div>
      </div>
    <div class="LoginFormOutest"style={{height:'50%',left:100}} >
      ...
      <div class='inputField' style={{height:'80%',width:'80%'}}>
        <form style={{opacity:1}}>
            <input style={{paddingLeft:10,color:'#000000',fontSize:'20px',width:'400px', height:'70px',marginBottom:'10px' , borderRadius: '20px'}} id="userid" placeholder={placeholderValue}type="text"/>
            <br/>
            <input style={{paddingLeft:10,opacity:1,color:'#000000',fontSize:'20px',width:'400px', height:'70px',marginTop:'10px', borderRadius: '20px'}}  id="password" placeholder="Password" type="text"/>
        </form>
      </div>
      <div class="break" style={{width:'10%'}}></div>
    </div>
      ...
      <div style={{position:'relative',fontSize:20, left: 420,fontWeight:'300', top :-20,height:'2.555%',fontFamily:'Mulish'}} >
          Forget Password?
      </div>
    </div>
  );
